...
Recently I got back from StanCon 2018 Ansilomar. I had a little time
...
days of tutorials, talks, and networking. I had a blast.
...
2. $\mathit{M}_{closed}$ - This one wasn't covered in detail.
...
an adverse health event. By sharing parameters between the two models
